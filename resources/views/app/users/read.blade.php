          ...
          <table class="table table-striped display" id="table_id">
            ...
            @foreach ($users as $us)
              <tr>
                ...
                <td>
                <a href="{{ route('users.show', $us->id) }}"  class="btn btn-sm btn-primary mb-1">Plus de details</a>

                <a href="{{ route('users.edit', $us->id) }}"  class="btn btn-sm btn-info  mb-1">Modifier</a>
