            ...
            <div class="card-body">
                <form class="row g-6" action="{{ route('products.update', $product->id) }}" method="POST">
                    ...
                    <div class="col-md-4 ">
                        ...
                        <input class="form-control" type="number" name="price_in" value="{{ $product->price_in }}">
                    </div>
                    <div class="col-md-4 ">
                        <label class="form-label" for="price_out">Prix de sortie du produit</label>
                        <input class="form-control" type="number" name="price_out" value="{{ $product->price_out }}">
                    </div>
                    <input hidden class="form-control" type="number" name="second_price_in" id="second_price_in"
                        value="{{ $product->second_price_in }}">
                    <input hidden class="form-control" type="number" name="second_price_out" id="second_price_out"
                        value="{{ $product->second_price_out }}">
